...
import { UseBinanceWebSocket } from "../../../../types/binance";
import { hasMoreThanOne, zeroString } from "../../../../utils";
...
export  function MarketRateContent() {
  ...
  useEffect(() => {
    if(currentAccount && presentedSwapContract?.pairName){
  ...
  ,
  [currentAccount, presentedSwapContract]
  )
