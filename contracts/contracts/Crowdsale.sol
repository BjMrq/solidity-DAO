...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    constructor(
        ...
        require(rateOfToken > 0, "rate is 0");
        require(walletAddress != address(0), "wallet is the zero address");
        require(address(tokenToSend) != address(0), "token is the zero address");
