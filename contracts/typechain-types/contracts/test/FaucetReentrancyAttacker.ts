...
export interface FaucetReentrancyAttackerInterface extends utils.Interface {
  functions: {
...
export interface FaucetReentrancyAttacker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FaucetReentrancyAttackerInterface;
