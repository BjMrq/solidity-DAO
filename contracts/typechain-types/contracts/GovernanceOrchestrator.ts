...
export declare namespace GovernanceOrchestrator {
...
export interface GovernanceOrchestratorInterface extends utils.Interface {
  functions: {
...
export interface GovernanceOrchestrator extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[GovernanceOrchestrator.ClearProposalStructOutput]>;
